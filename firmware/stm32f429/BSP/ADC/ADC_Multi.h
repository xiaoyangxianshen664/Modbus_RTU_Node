...
/* ================== 通道数量定义 ================== */
/* 总共启用2个ADC通道（扫描模式）：PC3 电位器、PA4 NTC */
#define ADC_CH_COUNT             2U

/* 每次 DMA 完成一批扫描后通知 AcquireTask，降低中断频率。 */
#define ADC_SAMPLES_PER_BATCH    32U
...
/*
 * DMA循环搬运的目标数组
 * 每一组连续存放 ADC_CH_COUNT 个通道的结果，重复 ADC_SAMPLES_PER_BATCH 组。
 */
#define ADC_BUF_SIZE             (ADC_CH_COUNT * ADC_SAMPLES_PER_BATCH)
