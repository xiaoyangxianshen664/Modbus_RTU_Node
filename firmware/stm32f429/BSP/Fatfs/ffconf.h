...
#define FF_FS_READONLY	0   /* 0=读写模式, 1=只读（裁剪掉 f_write/f_mkdir 等写 API，省空间） */
...
#define FF_USE_MKFS		1   /* 1=开启 f_mkfs 格式化功能（第一次挂载时创建 FAT 文件系统） */
...
#define FF_USE_STRFUNC	1   /* 1=开启 f_printf/f_puts（像 printf 一样往文件里写格式化文本） */
...
#define FF_CODE_PAGE	936   /* 936=简体中文 GBK 编码（932=日文, 437=英文, 0=全部加载） */
...
#define FF_USE_LFN		1   /* 1=长文件名支持（静态 BSS 缓冲区, 255 字符, 需 ffunicode.c） */
#define FF_MAX_LFN		255 /* 长文件名最大长度（UTF-16 码点, 255=完整支持） */
...
#define FF_MIN_SS		512  /* SD 卡扇区 = 512 字节，固定扇区模式 */
